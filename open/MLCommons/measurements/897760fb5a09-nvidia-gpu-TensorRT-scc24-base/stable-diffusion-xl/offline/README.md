...
### Accuracy Results 
`CLIP_SCORE`: `15.66165`, Required accuracy for closed division `>= 31.68632` and `<= 31.81332`
`FID_SCORE`: `232.00854`, Required accuracy for closed division `>= 23.01086` and `<= 23.95008`

### Performance Results 
`Samples per second`: `1.18002`
