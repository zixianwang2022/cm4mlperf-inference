...
cm pull repo gateoverflow@cm4mlops --checkout=4c76cf567fd78116e22db578a72ebbbfd9a46e03
...
### Accuracy Results 
`CLIP_SCORE`: `15.47615`, Required accuracy for closed division `>= 31.68632` and `<= 31.81332`
`FID_SCORE`: `238.00838`, Required accuracy for closed division `>= 23.01086` and `<= 23.95008`

### Performance Results 
`Samples per second`: `1.13923`
